...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	printf("Starting >> STM32F407G-DISC1_SPI-TX-RX-MasterRX-only_DMA_SingleBoard \n");
	...
	HAL_SPI_Receive_DMA(&hspi2, receive_data2, numdata);
	...
	printf("errorcode = %d \n", errorcode);
	printf("Ending >> STM32F407G-DISC1_SPI-TX-RX-MasterRX-only_DMA_SingleBoard \n");
